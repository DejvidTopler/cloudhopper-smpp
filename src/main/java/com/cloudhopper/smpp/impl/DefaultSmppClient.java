...
public class DefaultSmppClient implements SmppClient {
    ...
    @Override
    public SmppSession bind(SmppSessionConfiguration config,
            SmppSessionHandler sessionHandler) throws SmppTimeoutException, SmppChannelException, SmppBindException, UnrecoverablePduException, InterruptedException {
    ...
    protected DefaultSmppSession doOpen(SmppSessionConfiguration config,
